...
import com.example.fiobranco.helper.Base64Custom;
import com.example.fiobranco.model.Usuario;
...
public class CadastroActivity extends AppCompatActivity {
    ...
    public void cadastrarUsuario(){
        ...
        autenticacao.createUserWithEmailAndPassword(usuario.getEmail(), usuario.getEmail()
